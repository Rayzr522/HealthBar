                ...
                if (deathMessage.contains("killed") || deathMessage.contains("slain") || deathMessage.contains("got finished")) {
                    if (damager instanceof Player) {
                        ...
                        if (itemname == null) {
                            ...
                            event.setDeathMessage(victim + " was slain by " + damager.getName() + " using " + itemname);
                            return;
                        }
                ...
                if (deathMessage.contains("shot") || deathMessage.contains("shooted")) {
                    if (damager instanceof Projectile) {
                        ...
                        if (shooter instanceof Player) {
                            ...
                            if (itemname == null) {
                                event.setDeathMessage(victim + " was shot by " + player.getName());
                                return;
                            } else {
                                event.setDeathMessage(victim + " was shot by " + player.getName() + " using " + itemname);
                                return;
                            }
                        }
